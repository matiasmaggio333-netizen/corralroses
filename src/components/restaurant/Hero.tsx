...
export function Hero({ tableName, guestName, onGuestNameChange }: {
  ...
  return (
    <div className="bg-secondary text-secondary-foreground py-6 px-4 text-center">
      <div className="mx-auto w-28 h-28 md:w-32 md:h-32 rounded-full bg-[#FAF7F2] p-1 shadow-lg flex items-center justify-center"><img src="/logo.png" alt="El Corral Roses" className="w-full h-full object-contain rounded-full" /></div>
