...
const STRINGS = {
  es: {
    ...
    order_busy: "Hay muchos pedidos en este momento. Tu comida puede tardar un poco más de lo habitual.",
  ...
  ca: {
    ...
    order_busy: "Hi ha moltes comandes en aquest moment. El teu menjar pot trigar una mica més del normal.",
  ...
  en: {
    ...
    order_busy: "We're very busy right now. Your food may take a little longer than usual.",
  ...
  fr: {
    ...
    order_busy: "Nous sommes très occupés en ce moment. Votre repas peut prendre un peu plus de temps que prévu.",
  ...
  de: {
    ...
    order_busy: "Wir sind gerade sehr beschäftigt. Dein Essen kann etwas länger dauern als gewöhnlich.",
  ...
  nl: {
    ...
    order_busy: "Het is momenteel erg druk. Uw eten kan iets langer duren dan gewoonlijk.",
